...
fun availabilityFor(year: Int, month: Int, bookedDates: Set<LocalDate>): AvailabilityMonth {
    ...
    val weeks = generateSequence(calendarStart) { it.plusDays(1) }
            ...
            .map { AvailabilityDate(it.dayOfMonth, it.monthValue == month, isBooked = bookedDates.contains(it)) }
            .chunked(7)
